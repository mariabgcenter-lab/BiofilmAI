...
Project A (Genomic Profiling): Predictive modeling using differential transcriptomics [1].
Project B (BiofilmNN): High-throughput computer vision analysis of microbial microscopy images [1, 3].
Project C (Multimodal Fusion): Dual-channel feature alignment linking genomic profiles and bioimage phenotypes for integrated biofilm prediction [1].
🧫 Looking for the interactive dashboard?
The models and pipelines from this research repository are deployed as an interactive clinical web suite in lab-ai-compliance-suite.
Live Streamlit App: https://lab-ai-compliance-suite-icr9e9zehffzgw8qj4fdb2.streamlit.app/
...
03_model_training.ipynb — Trains classification systems (Random Forests, Gradient Boosting) and maps machine learning feature importances back to biochemical pathways [1].
...
│   └── 05_gene_level_predictions.ipynb
├── data/
